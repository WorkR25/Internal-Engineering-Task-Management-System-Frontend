...
function TrendChart({
  ...
  return (
    <div className="w-full">
      ...
      <div className="grid w-full grid-cols-6 text-center text-[10px] text-gray-400">
        {data.map((point) => (
    ...
    <div className="min-h-screen bg-[#f8f9fc]">
      ...
      <main className="ml-56 min-h-screen bg-[#f8f9fc] p-6">
        <div className="w-full">
          ...
          <div className="grid w-full gap-4 md:grid-cols-2 xl:grid-cols-4">
            {metrics.map((metric) => (
              ...
              >
                ...
                <p
                  className={`mt-1 text-xs ${toneText[metric.tone]}`}
                >
                  {metric.change}
                </p>
              </div>
          ...
          <section className="mt-5 w-full overflow-hidden rounded-xl border border-gray-200 bg-white">
