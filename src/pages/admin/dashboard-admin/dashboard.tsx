        ...
        <div className="content-wrapper">
          ...
          <div className="stats-grid">
            ...
            <div className="stat-card">
              ...
              <p className="stat-trend-neutral">12 currently in review</p>
            </div>
            ...
            <div className="stat-card">
              ...
              <p className="stat-trend-positive">+4% vs last sprint</p>
            </div>
          </div>
            ...
            <section className="section-card">
              <div className="section-header">
                <div>
                  ...
                  <p className="section-subtitle">6 total · sorted by target end date</p>
                </div>
